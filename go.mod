...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/common v0.3.1-0.20240411114225-8e997e0e448a
...
replace github.com/openstack-k8s-operators/octavia-operator/api => ./api

// mschuppert: map to latest commit from release-4.13 tag
// must consistent within modules and service operators
replace github.com/openshift/api => github.com/openshift/api v0.0.0-20230414143018-3367bc7e6ac7 //allow-merging

replace github.com/openstack-k8s-operators/infra-operator/apis => github.com/stuggi/infra-operator/apis v0.0.0-20240411103156-322830be3bcd
